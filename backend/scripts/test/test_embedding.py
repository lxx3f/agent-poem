...
if __name__ == "__main__":
    ...
    print(len(text))
    print(
        f"Embedding向量长度：{len(embedding)}")  # 不同模型长度不同（如nomic-embed-text是768维）
